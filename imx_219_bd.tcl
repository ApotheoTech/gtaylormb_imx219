...
################################################################
# This is a generated script based on design: imx_219_bd
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set rpi_en [ create_bd_port -dir O -from 0 -to 0 rpi_en ]

  # Create instance: PL_250MHz_RST, and set properties
  set PL_250MHz_RST [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 PL_250MHz_RST ]
  ...
  # Create instance: clk_148_5_MHz, and set properties
  set clk_148_5_MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_148_5_MHz ]
  set_property -dict [list \
  ...
  # Create instance: ila_axi4s_vid_out, and set properties
  set ila_axi4s_vid_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_axi4s_vid_out ]
  set_property -dict [list \
  ...
  # Create instance: ila_gamma, and set properties
  set ila_gamma [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_gamma ]
  set_property CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S} $ila_gamma


  # Create instance: ila_mipi, and set properties
  set ila_mipi [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_mipi ]
  set_property CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S} $ila_mipi


  # Create instance: ila_to_vid_out, and set properties
  set ila_to_vid_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_to_vid_out ]
  set_property CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S} $ila_to_vid_out
  ...
  # Create instance: rpi_en, and set properties
  set rpi_en [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 rpi_en ]

  # Create instance: smartconnect_0, and set properties
  set smartconnect_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 smartconnect_0 ]

  # Create instance: sys_148_5_vid_clk_rst, and set properties
  set sys_148_5_vid_clk_rst [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 sys_148_5_vid_clk_rst ]
  ...
  set_property CONFIG.MAX_DATA_WIDTH {10} $v_demosaic_0
  ...
  set_property CONFIG.MAX_DATA_WIDTH {10} $v_gamma_lut_0
...
MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#SD 0#SD 0#SD 0#I2C 1#I2C 1#PMU GPI 0#DPAUX#DPAUX#DPAUX#DPAUX#PMU GPI 5####PMU GPO 3#UART 1#UART 1##SD 1####SD 1#USB0 Reset#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB\
0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0###########I2C 0#I2C 0##} \
    CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#sclk_out#gpio0[7]#gpio0[8]#n_ss_out[0]#miso#mosi#gpio0[12]#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#gpio0[17]#gpio0[18]#gpio0[19]#gpio0[20]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow#scl_out#sda_out#gpi[0]#dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in#gpi[5]####gpo[3]#txd#rxd##sdio1_data_out[4]####sdio1_bus_pow#reset#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]###########scl_out#sda_out##}\
\
...
\
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins v_tc_0/ctrl]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins v_gamma_lut_0/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins axi_vdma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins v_axi4s_vid_out_0/video_in]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins ila_to_vid_out/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets mipi_csi2_rx_subsyst_0_video_out] [get_bd_intf_pins ila_mipi/SLOT_0_AXIS] [get_bd_intf_pins v_demosaic_0/s_axis_video]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets v_gamma_lut_0_m_axis_video] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM] [get_bd_intf_pins ila_gamma/SLOT_0_AXIS]
  ...
  connect_bd_net -net PL_250MHz_RST_peripheral_reset [get_bd_pins PL_250MHz_RST/peripheral_reset] [get_bd_pins clk_148_5_MHz/reset]
  connect_bd_net -net clk_148_5_MHz_clk_out1 [get_bd_pins clk_148_5_MHz/clk_out1] [get_bd_pins ila_axi4s_vid_out/clk] [get_bd_pins sys_148_5_vid_clk_rst/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk] [get_bd_pins zynq_ultra_ps_e_0/dp_video_in_clk]
  connect_bd_net -net clk_148_5_MHz_locked [get_bd_pins clk_148_5_MHz/locked] [get_bd_pins sys_148_5_vid_clk_rst/dcm_locked]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins mipi_csi2_rx_subsyst_0/dphy_clk_200M]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins PL_250MHz_RST/peripheral_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_demosaic_0/ap_rst_n] [get_bd_pins v_gamma_lut_0/ap_rst_n] [get_bd_pins v_tc_0/s_axi_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn1 [get_bd_pins sys_148_5_vid_clk_rst/peripheral_aresetn] [get_bd_pins v_tc_0/resetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins sys_148_5_vid_clk_rst/peripheral_reset] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset]
  connect_bd_net -net rpi_en_dout [get_bd_ports rpi_en] [get_bd_pins rpi_en/dout]
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_pins ila_axi4s_vid_out/probe0] [get_bd_pins v_axi4s_vid_out_0/locked]
  connect_bd_net -net v_axi4s_vid_out_0_status [get_bd_pins ila_axi4s_vid_out/probe5] [get_bd_pins v_axi4s_vid_out_0/status]
  connect_bd_net -net v_axi4s_vid_out_0_underflow [get_bd_pins ila_axi4s_vid_out/probe1] [get_bd_pins v_axi4s_vid_out_0/underflow]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins ila_axi4s_vid_out/probe4] [get_bd_pins v_axi4s_vid_out_0/vid_active_video] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_de]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins ila_axi4s_vid_out/probe2] [get_bd_pins v_axi4s_vid_out_0/vid_hsync] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins ila_axi4s_vid_out/probe3] [get_bd_pins v_axi4s_vid_out_0/vid_vsync] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_vsync]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins PL_250MHz_RST/slowest_sync_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins clk_148_5_MHz/clk_in1] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ila_gamma/clk] [get_bd_pins ila_mipi/clk] [get_bd_pins ila_to_vid_out/clk] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_demosaic_0/ap_clk] [get_bd_pins v_gamma_lut_0/ap_clk] [get_bd_pins v_tc_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins PL_250MHz_RST/ext_reset_in] [get_bd_pins sys_148_5_vid_clk_rst/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_demosaic_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_tc_0/ctrl/Reg] -force
